...
def get_proxy_ip_per_request():
    return cf.get('proxy_ip_per_reqeust')

def get_proxy_max_retries():
    return cf.get('proxy_max_tries')

def moguproxy_order():
    return cf.get('moguproxy_order')

def get_proxy_speed_filter():
    return cf.get('proxy_speed_filter')

def get_proxy_time_out():
    return cf.get('proxy_time_out')

def get_proxy_ip_min_req_interal():
    return cf.get('proxy_ip_min_req_interal')

def get_proxy_ip_max_req_interal():
    return cf.get('proxy_ip_max_req_interal')

def daxiangproxy_order():
    return cf.get('daxiangproxy_order')
